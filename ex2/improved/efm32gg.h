...
#define DMA_SOURCESEL_DAC0 (0b001010)
#define DMA_SIGSEL_DAC0CH0 (0b0000)
#define DMA_SIGSEL_DAC0CH1 (0b0001)
...
#define PRS_SOURCESEL_TIMER0 (0b011100)
#define TIMER_UNDERFLOW (0x001)
